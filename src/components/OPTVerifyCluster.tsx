...
export function OTPVerifyCluster() {
    ...
    return <>
        <div className='info-message'>A four-digit one-time passcode has been sent to your phone by SMS. Please enter the code to verify your phone number.</div>
        <Form className="otp-input-cluster" onSubmit={handleSubmit}>
            <Form.Control className='otp-input-control' type="text" maxLength={4} onChange={e => {handleOTPChange(e)}}/>
            <Button type="submit" className='otp-input-control standard-button'>Verify</Button>
        </Form>
    </>
}