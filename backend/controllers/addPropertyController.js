...
exports.state = (req, res) => {
    ...
    .then(response => {
      // Handle the data from the API response
        console.log("HOMEOWNER GET ALL STATE:");
...
exports.city = (req, res) => {
    ...
    .then(response => {
      console.log("HOMEOWNER GET ALL CITY RESPONSE:");
      console.log(response.data);
      // Handle the data from the API response
...
exports.zip = (req, res) => {
    ...
    .then(response => {
      // Handle the data from the API response
        console.log("HOMEOWNER GET ZIP RESPONSE:");
        console.log(response.data);
        const rawData = response.data;
...
exports.addProperty = (req, res) => {
    ...
    .then(response => {
      // Handle the data from the API response
        console.log("HOMEOWNER ADD PROPERTY RESPONSE:");
        console.log(response.data);
        const rawData = response.data;
          ...
          .then(response => {
            ...
            .then(response => {
              ...
              if (response.data.isSuccess){
                ...
                .then(response => {
                  console.log("HOMEOWNER DELETE UNVALIDATED PROPERTY RESPONSE:")
                  console.log(response.data);
                })
                .catch(error => {
                  // Handle errors
...
exports.getPropertyTypes = (req,res) => {
  ...
  axios.get(PROPERTY_TYPE_LINK, {'headers': propertyTypesHeaders}).then(response => {
    console.log("HOMEOWNER GET PROPERTY TYPE:");
    console.log(response.data);
    const rawData = response.data;
    const refinedData = rawData.data.map(item => ({
      name: item.type,
