...
export function ApplyPublicPrompt(props: ApplyPublicPromptProps) {
    ...
    if (props.isPublic) {
        return (
            <div className="apply-public mb-5">
                ...
                <p>
                    You have passed the background check and are now verified with public service provider status.
                    You will now be able to recieve service requests from all users of the HomeTrumpeter system.
                </p>
            </div>
        )
    }
    ...
    return (
        <div className="apply-public mb-5">
                    ...
                    <p>
                        Public service providers can advertise their services to all homeowners and property
                        managers on HomeTrumpeter. Expand your business reach with public status!
                    </p>

                    <Button className='standard-button' onClick={()=> {navigate('/apply-public')}}>Apply now!</Button>
                </div>
    )
}