    ...
    return (
        <Card style={{width: '18rem'}}>
            <Card.Body>
                ...
                <Card.Text>{"Radius of Operation: " + props.sp.spDetail?.distanceCovered + " miles"}</Card.Text>
                ...
                {props.isLoading ? (
                    ...
                    <div className="d-grid">
                        <Button onClick={() => {props.buttonHandler(props.sp)}}className="standard-button">Request Quote</Button>
                    </div>
                )}
            </Card.Body>
        </Card>
