...
export function RequestQuoteTable(props: RequestQuoteTableProps) {
    return (
        <table className="dashboard-table">
            ...
            <tbody>
                {Array.isArray(props.serviceProviders) && props.serviceProviders.length > 0 ? (
                    props.serviceProviders.map(sp => (
                        <tr>
                            <td>{sp.spDetail.company}</td>
                            <td>{sp.spDetail.isPublic ? "Public" : "Private"}</td>
                            ...
                            <td>
                                <Button 
                                    ...
                                    onClick={() => {props.handleSubmitRequest(sp)}}
                                >
                                    Request Quote
                                </Button>
                            </td>
                        ...
                        <tr>
                            <td colSpan={6}>No Available Service Providers Found!</td>
                        </tr>
                    )
