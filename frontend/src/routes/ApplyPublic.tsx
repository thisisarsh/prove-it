...
export function ApplyPublic() {
    ...
    const handleApplyForPublic = () => {
        if (!consent) {
            setError("You must consent to the background check to apply for public status.")
            ...
            const applyPublicBody = {bgCheck: backgroundCheckBody, spDetail: newSpDetail}
    ...
    return (
        <div className="login-container">
            ...
            <div style={{width:"90%", maxWidth:"600px"}}>
                <Stack gap={3}>
                    <p>
                        Public service provider status allows you to advertise your services and respond to service requests from
                        all HomeTrumpeter users.
                    </p>

                    <p>
                        To become a public service provider, you will be required to complete a background check with our verification
                        partners <a href="https://certn.co/">Certn</a>.
                    </p>

                    <p>
                        Once your background check is approved, you will be able to recieve service requests from all HomeTrumpeter
                        users within your range of operation.
                    </p>
