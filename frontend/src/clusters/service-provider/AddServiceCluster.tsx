...
import { GeneralServiceType, ServiceOffering, SpecificServiceType, Timeline } from "../../types";
...
export function AddServiceCluster() {
    ...
    const addNewOffering = () => {
        ...
        setServiceOfferings(serviceOfferings => [...serviceOfferings, newService])
    }
                ...
                {serviceOfferings.map((offering, index) => (
                    <Form.Group>
                        ...
                        <SearchableDropdown
                            ...
                            onSelect={(specService) : void => {handleSpecServiceSelect(specService, index)}}
                            placeholder={
                                offering.service ? offering.service.serviceType : "Select a service"
                            }
                            labelKey="serviceType"
                        />
                        ...
                        <SearchableDropdown
                            items={timelines}
                            onSelect={(timeline) : void => {handleTimelineSelect(timeline, index)}}
                            placeholder={
                                offering.timeline ? offering.timeline.title : "Select a typlical timeline"
                            }
                            labelKey="title"
                        />
